...
public class SecureRedirectUriExecutorFactory implements ClientPolicyExecutorFactory {

    public static final String PROVIDER_ID = "redirecturi-exactmatch-executor";

    @Override
    public ClientPolicyExecutor create(KeycloakSession session, ComponentModel model) {
        return new SecureRedirectUriExecutor(session ,model);
    }
