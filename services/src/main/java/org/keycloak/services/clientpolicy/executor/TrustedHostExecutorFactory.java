...
public class TrustedHostExecutorFactory implements ClientPolicyExecutorProviderFactory {
    ...
    public ClientPolicyExecutorProvider create(KeycloakSession session, ComponentModel model) {
        return new TrustedHostExecutor(session, model);
    }
    ...
    public void validateConfiguration(KeycloakSession session, RealmModel realm, ComponentModel config) throws ComponentValidationException {
        ...
        TrustedHostExecutor executor = new TrustedHostExecutor(session, config);
