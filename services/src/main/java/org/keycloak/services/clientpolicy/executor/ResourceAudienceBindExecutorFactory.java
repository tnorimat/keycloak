 ...
 */
public class ResourceAudienceBindExecutorFactory implements ClientPolicyExecutorProviderFactory {

    public static final String PROVIDER_ID = "resource-audience-bind";
    ...
    public ClientPolicyExecutorProvider create(KeycloakSession session) {
        return new ResourceAudienceBindExecutor(session);
    }
