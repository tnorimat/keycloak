...
public class SecureSigningAlgorithmExecutorFactory implements ClientPolicyExecutorFactory {

    public static final String PROVIDER_ID = "secure-signalg-executor";

    @Override
    public ClientPolicyExecutor create(KeycloakSession session, ComponentModel model) {
        return new SecureSigningAlgorithmExecutor(session, model);
    }
