...
public class DynamicClientRemoveContext implements ClientUpdateContext {
    ...
    public DynamicClientRemoveContext(KeycloakSession session, ClientRegistrationProvider provider,
