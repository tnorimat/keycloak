...
public class HoKTokenEnforceExecutorFactory implements ClientPolicyExecutorFactory {

    public static final String PROVIDER_ID = "hok-enforce-executor";

    @Override
    public ClientPolicyExecutor create(KeycloakSession session, ComponentModel model) {
        return new HoKTokenEnforceExecutor(session, model);
    }
