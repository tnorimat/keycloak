...
public class SecureSessionsExecutorFactory implements ClientPolicyExecutorFactory {

    public static final String PROVIDER_ID = "secure-sessions-executor";

    @Override
    public ClientPolicyExecutor create(KeycloakSession session, ComponentModel model) {
        return new SecureSessionsExecutor(session, model);
    }
